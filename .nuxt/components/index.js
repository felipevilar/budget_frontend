...
export { default as DeleteDialog } from '../..\\components\\budget\\DeleteDialog.vue'
export { default as ExpandedProductView } from '../..\\components\\budget\\ExpandedProductView.vue'
export { default as FooterBudget } from '../..\\components\\budget\\FooterBudget.vue'
...
export const LazyDeleteDialog = import('../..\\components\\budget\\DeleteDialog.vue' /* webpackChunkName: "components_budget/DeleteDialog" */).then(c => c.default || c)
export const LazyExpandedProductView = import('../..\\components\\budget\\ExpandedProductView.vue' /* webpackChunkName: "components_budget/ExpandedProductView" */).then(c => c.default || c)
export const LazyFooterBudget = import('../..\\components\\budget\\FooterBudget.vue' /* webpackChunkName: "components_budget/FooterBudget" */).then(c => c.default || c)
